...
const filesToCreate = [
  ...
  },
  {
    path: './src/index.ejs',
    content:
      '<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=edge, chrome=1"><title>Custom React App</title></head><body><div id="app"></div></body></html>'
  },
  {
